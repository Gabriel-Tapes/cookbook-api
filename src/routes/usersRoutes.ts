...
import { getUserByEmailController, getUserByIdController, getUsersByNameController, getAllUsersController } from '../useCases/usersUseCases/getUsers'
...
routes.get('/users/search', (req, res) => {
   if (req.query.name)
      return getUsersByNameController.handle(req, res)
   else if (req.query.email)
      return getUserByEmailController.handle(req, res)
